...
class ParserTest extends TestCase
{
    ...
    {
        $classAttributesGroup = Group::create('class-attributes', null);
        ...
        foreach ([
            ...
            'Group Attributes' => [
                ...
                Group::create('group1', '/g1')
                    ->hosts([new GroupHost('https://www.example1.com')])
                    ->cors(new GroupCors(CorsMiddleware::class))
                    ->middlewares([new GroupMiddleware(GroupLevelMiddleware::class)])
                    ->route(
            ...
            'Group With Prefix Attributes' => [
                ...
                ,
                'group2',
                Group::create('group2', '/example/{locale:[a-z]{2}}')
                    ->hosts([new GroupHost('https://www.example1.com')])
                    ->cors(new GroupCors(CorsMiddleware::class))
                    ->middlewares([new GroupMiddleware(GroupLevelMiddleware::class)])
                    ->route(
